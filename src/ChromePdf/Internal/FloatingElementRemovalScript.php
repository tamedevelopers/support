...
final class FloatingElementRemovalScript
{
    ...
    /**
     * Adds a cheap print-time hide layer so removed overlays/widgets do not reappear in PDF layout edge cases
     * such as zero margins or sites that re-toggle them during print styling.
     */
    public static function buildDefaultPrintHideCss(): string
    {
        return <<<'CSS'
            @media print {
                #onetrust-banner-sdk,
